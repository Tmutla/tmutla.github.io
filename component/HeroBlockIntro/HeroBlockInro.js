	...
	return (
		<section className="relative w-full h-vh-50 overflow-hidden">
				...
				<div className="absolute w-full h-full pt-4">
					<p className="m-2 text-vw-4 sm:text-vw-5  text-black text-opacity-85">
						{/* Evolve beyond threats */}
						Building The Foundations of Cybersecurity 
					</p>
					<div className="leading-8 md:leading-6 text-vw-3 md:text-vw-3 lg:text-vw-2 2xl:text-vw-1 max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl border-t-4 border-solid border-red">
