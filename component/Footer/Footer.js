		...
		<footer className="relative w-full text-gray-600 body-font bg-gray hero-overlay text-white">
			...
			<div className="bg-gray-100">
				<div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
					...
					<p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2020 Tmutla —
					...
					<span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
						{/* Facebook */}
						<a className="text-gray-500" href="https://www.facebook.com/TmutlaInc/">
							<svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-12 h-12" viewBox="0 0 24 24">
						...
						<a className="ml-12 text-gray-500" href="https://www.linkedin.com/company/tmutla/">
							<svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" className="w-12 h-12" viewBox="0 0 24 24">
